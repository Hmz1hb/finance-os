  ...
  if (!open) {
    return (
      <button
        ...
        className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-blue-ledger hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-ledger"
      >
        + Contribute
      </button>
    );
